...
def feature_map_score(
    ...
    """Score feature mapping between inspiration and derivative molecule"""
    ...
    if draw:
        from molparse.rdkit.draw import draw_mol
...
def multi_feature_map_score(
    inspirations: "list[rdkit.Chem.Mol]",
    derivative: "rdkit.Chem.Mol",
    debug: bool = False,
    draw: bool = False,
    score_mode=FeatMaps.FeatMapScoreMode.All,
    ...
    """Score feature mapping between multiple inspirations and derivative molecules"""
